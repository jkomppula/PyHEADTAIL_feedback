...
class TurnResampler(object):
    def __init__(self,h_RF, multiplier, circumference, data_conversion = 'sum'):
        self._h_RF = h_RF
        self._multiplier = multiplier
        self._circumreference = circumference
        self._data_conversion = 'sum'

        self._intput_parameters = None
        self._output_parameters = None


    def __generate_binset(self,parameters):
        first_bunch = np.min(parameter['segment_midpoints'])
        last_bunch = np.max(parameter['segment_midpoints'])



        pass

    def __conver_signal(self, input_signal):
        pass
