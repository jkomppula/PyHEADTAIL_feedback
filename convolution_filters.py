...
class BunchImpulse(object):
    """
        An object, which handels data for one bunch. The variable total_impulse is the total impulse generated by
...
class Lowpass(Filter):
    def __init__(self,f_cutoff, norm_type=None, norm_range=None, impulse_length = 6.):
