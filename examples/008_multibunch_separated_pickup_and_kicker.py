...
pickup_processors_y = [
    ChargeWeighter(normalization = 'average',store_signal  = True),
    Averager(store_signal  = True),
    HilbertPhaseShiftRegister(n_values, machine.accQ_y, delay,store_signal  = True)
]
...
kicker_processors_x = [Bypass(store_signal  = True)]
kicker_processors_y = [Bypass(store_signal  = True)]
